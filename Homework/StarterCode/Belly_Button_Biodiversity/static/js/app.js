...
// buildGauge(data.WFREQ); I just built the bonus as part of the previous function
    ...
    var data = [{ type: 'scatter',
      ...
      textinfo: 'text',
      textposition:'inside',
      marker: {colors:['#00ffff','#40e0d0','#ffd700', '#ff0000',
                          '#d3ffce', '#008080','#ffa500',
                          '#e6e6fa','#b0e0e6','rgba(255, 255, 255, 0)']},
...
function buildCharts(sample) {
  ...
  d3.json(chartsURL).then(function (data) {
    ...
    var pieLayout = {
      'title': "Top Ten Microbe Species by OTU ID",
      margin: {t: 100, l: 75, b: 100}
    };
    Plotly.react("pie", pie_data, pieLayout)
}
)}
